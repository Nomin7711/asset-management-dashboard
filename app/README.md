...
For full submission notes (setup, architecture, future considerations, summary), see **`NOTES.md`** at the project root.
...
**1. Start the backend API** (from project root, parent of `app/`):
...
**2. Install and run the frontend** (from this `app/` directory):
